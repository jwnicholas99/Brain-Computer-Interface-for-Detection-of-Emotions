...
LPFN_WOW64DISABLE	fnWow64Disable	 = (LPFN_WOW64DISABLE)GetProcAddress(GetModuleHandle("kernel32"),"Wow64DisableWow64FsRedirection");
LPFN_WOW64REVERT	fnWow64Revert	 = (LPFN_WOW64REVERT)GetProcAddress(GetModuleHandle("kernel32"),"Wow64RevertWow64FsRedirection");
