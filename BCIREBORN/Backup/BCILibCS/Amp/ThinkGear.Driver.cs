...
namespace BCILib.Amp
{
    ...
    partial class ThinkGear
    {
        ...
        public const int DATA_RAW2 = 13;
        public const int DATA_RAW3 = 14;
        public const int DATA_RAW4 = 15;
        public const int DATA_RAW5 = 16;
        public const int DATA_RAW6 = 17;
        public const int DATA_RAW7 = 18;

        public const int TG_DATA_EEG_RAW_TIMESTAMP1 = 19;
        public const int TG_DATA_EEG_RAW_TIMESTAMP2 = 20;
        public const int TG_DATA_EEG_RAW_TIMESTAMP3 = 21;
        public const int TG_DATA_EEG_RAW_TIMESTAMP4 = 22;
        public const int TG_DATA_EEG_RAW_TIMESTAMP5 = 23;
        public const int TG_DATA_EEG_RAW_TIMESTAMP6 = 24;
        public const int TG_DATA_EEG_RAW_TIMESTAMP7 = 25;

        // Accelerometer value for each axis (units not yet defined)
        public const int TG_DATA_ACCEL_X = 26;
        public const int TG_DATA_ACCEL_Y = 27;
        public const int TG_DATA_ACCEL_Z = 28;

        //* Temperature data (units not yet defined)
        public const int TG_DATA_TEMPERATURE_RAW = 29;

        //* GSR data (units not yet defined) *
        public const int TG_DATA_GSR_RAW = 30;
        ...
        public const string DllPath = "ThinkGear.dll";
