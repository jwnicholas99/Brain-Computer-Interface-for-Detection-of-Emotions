...
//int CSignalProc::SVD(double **a, int m, int n, double *q, double **v)
//{
//	double eps;
//	double tol;
//	double **u;
...
//	double *e;
//
//	sscanf_s("3CB0000000000000", "%I64x", &eps);
//	tol = max(m, n) * eps;
//
//	e = new double[n];
//	retval = 0;
...
int CSignalProc::SVD(double **a, int m, int n, double *w, double **v)
{
